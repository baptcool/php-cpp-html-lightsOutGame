        ...
        <header>
            ...
            <div id="wrapRight">
                ...
                <form action="index.php" method="get">
                    <button type="submit"   class="choixBouton" id="second_perso">Valider le<br>tableau</button>
                </form>
            </div>
        </header>
        <section id="gameWrapper_index">
            <article id="jeu">
                ...
                if (isset($_SESSION["light"])) {    #si il existe deja une session
                    ...
                    $light->afficher_personnalise();  //fonction personnaliser pour afficher le tableau
